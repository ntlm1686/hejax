...
from hejax.ckks.utils import get_modulo, shift_mod
...
def make_polynomial_ring(q: int, n: int):
    ...
    class PolynomialRing(object):
        ...
        def round(self):
            # return PolynomialRing(jnp.round(self.coeffs.astype(jnp.int64)), q)
            return PolynomialRing(jnp.round(self.coeffs), q)
